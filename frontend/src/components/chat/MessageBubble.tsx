    ...
    >
      ...
      <div
        className={clsx(
          ...
          isUser
            ? "bg-gradient-to-br from-blue-500 to-indigo-600 text-white rounded-br-sm shadow-md shadow-blue-500/20"
            : "bg-white/[0.08] border border-white/10 text-white/90 rounded-bl-sm shadow-sm backdrop-blur-sm"
        )}
